...
export const MEME_TEMPLATES: MemeTemplate[] = [
  ...
  },
  {
    ...
    defaultTextBoxes: [
      ...
      { x: 3, y: 53, width: 45, text: '' },
      { x: 3, y: 78, width: 45, text: '' },
    ],
  },
  {
  ...
  },
  {
    ...
    defaultTextBoxes: [
      ...
      { x: 55, y: 53, width: 40, text: '' },
      { x: 55, y: 78, width: 40, text: '' },
    ],
  },
  {
  ...
  },
  {
    ...
    defaultTextBoxes: [
      ...
      { x: 55, y: 42, width: 40, text: '' },
      { x: 55, y: 62, width: 40, text: '' },
      { x: 55, y: 82, width: 40, text: '' },
    ],
  },
  {
    id: 'epic-handshake',
  ...
  },
  {
    ...
    defaultTextBoxes: [
      ...
      { x: 60, y: 5, width: 20, text: '' },
      { x: 80, y: 30, width: 18, text: '' },
    ],
  },
  {
  ...
  },
  {
    ...
    defaultTextBoxes: [
      ...
      { x: 5, y: 53, width: 45, text: '' },
      { x: 5, y: 78, width: 45, text: '' },
    ],
  },
  {
...
export const TEMPLATE_CATEGORIES = [
  ...
  { id: 'classic', name: 'Classic Memes' },
  { id: 'reaction', name: 'Reaction Memes' },
